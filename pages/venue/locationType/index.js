...
const VenueLocationType = () => {
    ...
    try {
      ...
      if (result.status) {
        ...
        toaster(
          "success",
          isEditId
            ? "Location Type Successfully Updated!"
            : "Location Type Successfully Added!"
        );
      }
    } catch (error) {
  ...
  const handleItemDelete = async (val) => {
    ...
    const res = confirm(`Are you sure you want to remove this location type`);
    if (res) {
      try {
        setIsLoading(true);
        ...
        if (result.status) {
          fetchVenueEntityList();
          handleFormToggle(false);
          toaster("success", "Location Type Remove Successfully");
        }
      } catch (error) {
        console.log("Error ::", error);
      } finally {
                ...
                <div className="col-lg-12">
                  <div className="ibox ">
                    <div className="ibox-title">
                      <h5>
                        Venue Location Type <small>Create</small>
                      </h5>
                    </div>
...
export default VenueLocationType;
