...
const VenueBeverage = () => {
    ...
    try {
      ...
      if (result.status) {
        ...
        toaster(
          "success",
          isEditId
            ? "Beverage Successfully Updated!"
            : "Beverage Successfully Added!"
        );
      }
    } catch (error) {
  ...
  const handleItemDelete = async (val) => {
    ...
    const res = confirm(`Are you sure you want to remove this beverage`);
    if (res) {
      try {
        setIsLoading(true);
        ...
        if (result.status) {
          fetchVenueEntityList();
          handleFormToggle(false);
          toaster("success", "Beberage Remove Successfully");
        }
      } catch (error) {
        console.log("Error ::", error);
      } finally {
                ...
                <div className="ibox">
                  <div className="ibox-title">
                    ...
                    <div className="ibox-tools">
                      ...
                      >
                        <i className="fa fa-plus" title="Add Beverage"></i>
                      </a>
                    </div>
                  </div>
