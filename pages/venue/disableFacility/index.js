...
const VenueDisableFacility = () => {
    ...
    try {
      ...
      if (result.status) {
        ...
        toaster(
          "success",
          isEditId
            ? "Disable Facility Successfully Updated!"
            : "Disable Facility Successfully Added!"
        );
      }
    } catch (error) {
  ...
  const handleItemDelete = async (val) => {
    ...
    const res = confirm(
      `Are you sure you want to remove this disable facility`
    );
    if (res) {
      try {
        setIsLoading(true);
        ...
        if (result.status) {
          fetchVenueEntityList();
          handleFormToggle(false);
          toaster("success", "Disable Facility Remove Successfully");
        }
      } catch (error) {
        console.log("Error ::", error);
      } finally {
                ...
                <div className="col-lg-12">
                  <div className="ibox ">
                    <div className="ibox-title">
                      <h5>
                        Venue Disable Facilities <small>Create</small>
                      </h5>
                    </div>
...
export default VenueDisableFacility;
